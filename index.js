...
document.getElementById("rock").addEventListener("click", function(){
    ...
    document.getElementById("pokéChangeLeft").src = "https://raw.githubusercontent.com/Fib88/js-Rock-Paper-Scissors/master/geodude.png";
})
...
document.getElementById("paper").addEventListener("click", function(){
    ...
    playerChoice = "paper";
    document.getElementById("choice-player").innerText = "Trainer picks " + playerChoice;
    document.getElementById("pokéChangeLeft").src ="https://raw.githubusercontent.com/Fib88/js-Rock-Paper-Scissors/master/bellsprout.png";
})
...
scissors = document.getElementById("scissors").addEventListener("click", function(){
    ...
    document.getElementById("choice-player").innerText = "Trainer picks " + playerChoice;
    document.getElementById("pokéChangeLeft").src = "https://raw.githubusercontent.com/Fib88/js-Rock-Paper-Scissors/master/krabby.png";
})
 ...
 document.getElementById("computerChoice").addEventListener("click", function(){
    ...
    if (randomNumber==1){
        ...
        document.getElementById("pokéChangeRight").src = "https://raw.githubusercontent.com/Fib88/js-Rock-Paper-Scissors/master/geodude.png";
    }
    else if(randomNumber==2){
         computerChoice = "paper";
        document.getElementById("choice-computer").innerText = "Rival picks " + computerChoice;
        console.log(" computer picks paper");
        document.getElementById("pokéChangeRight").src = "https://raw.githubusercontent.com/Fib88/js-Rock-Paper-Scissors/master/bellsprout.png";
    }
    else if(randomNumber==3){
        computerChoice ="scissors";
        document.getElementById("choice-computer").innerText = "Rival picks " + computerChoice;
        console.log(" computer picks scissors");
        document.getElementById("pokéChangeRight").src = "https://raw.githubusercontent.com/Fib88/js-Rock-Paper-Scissors/master/krabby.png";
    }
...
document.getElementById("reset").addEventListener("click", function(){
    ...
    document.getElementById("pokéChangeLeft").src = "https://raw.githubusercontent.com/Fib88/js-Rock-Paper-Scissors/master/pokeball_PNG24.png";
    document.getElementById("pokéChangeRight").src = "https://raw.githubusercontent.com/Fib88/js-Rock-Paper-Scissors/master/pokeball_PNG24.png";
